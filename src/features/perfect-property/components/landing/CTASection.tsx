  ...
  return (
    <section className="py-32 bg-[#0F0F0F] text-white overflow-hidden relative">
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-full h-full overflow-hidden pointer-events-none opacity-30">
        <div className="absolute top-[-50%] left-[-10%] right-[-10%] h-[150%] bg-[radial-gradient(circle_at_center,_#2F5FFF_0%,_transparent_70%)] blur-[100px]" />
      </div>
      ...
      <div className="max-w-[1200px] mx-auto px-6 text-center relative z-10">
        ...
        >
          <button 
            onClick={onExplore}
            className="h-14 px-10 bg-[#2F5FFF] text-white rounded-xl font-bold hover:bg-[#2555FF] transition-all shadow-xl shadow-[#2F5FFF]/20 w-full sm:w-auto cursor-pointer"
          >
            Sign up for free
          </button>
