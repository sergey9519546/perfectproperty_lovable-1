...
/**
 * Timeline — Aceternity UI component.
 * Vertical sequence with scroll-driven progress indicator and clean typography.
 */
export function Timeline({ data, title, description, className }: TimelineProps) {
